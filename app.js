...
const songs = [{
    ...
    songName: `Putt Jatt Da <br>
        <div class="subtitle">Put Jatt Da</div>`,
    poster: "img/12.jpg"
}, {
    id: "13",
    ...
    id: "17",
    songName: `Btao Yaad h Tumko wo Jab Dil ko Churaya Tha <br>
        <div class="subtitle">Alan Walker</div>`,
    poster: "img/17.jpg"
}, {
    id: "18",
    ...
    id: "19",
    songName: `Ek Munda Pagal ne Sare <br>
...
// Scroll through popular artists
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        ...
        songTitles.forEach((elss) => {
            ...
            download_music.setAttributes('download', songName);
        });
